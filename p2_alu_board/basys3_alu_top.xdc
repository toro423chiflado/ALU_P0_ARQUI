## ============================================================================
## Pregunta 2 - Constraints para basys3_alu_top (ALU de 5 bits)
...
set_property -dict { PACKAGE_PIN W2   IOSTANDARD LVCMOS33 } [get_ports {sw[12]}]  ; # sin uso
set_property -dict { PACKAGE_PIN U1   IOSTANDARD LVCMOS33 } [get_ports {sw[13]}]  ; # sin uso
set_property -dict { PACKAGE_PIN T1   IOSTANDARD LVCMOS33 } [get_ports {sw[14]}]  ; # sin uso
